...
__Ваше приложение может запустить activity другого приложения, передав Intent в метод startActivity()__. ОС Android знает о всех установленных на устройство приложениях, и о всех их activity, и использует Intent для запуска соответствующей activity.__
...
(__ВООБЩЕ НЕПОНЯТНО ЧТО ТАКОЕ TASK__)
